...
| **UI Options**                          |                                                                                                                                                                                                       |
| `jestrunner.testInterface`              | Choose test interface: `"testExplorer"` (modern VS Code Testing API & Test Explorer) or `"codeLens"` (legacy inline buttons). Set to `"testExplorer"` to use the new Test Explorer view. Default: `"codeLens"` |
| `jestrunner.codeLens`                   | Specify which CodeLens actions to show when using `"codeLens"` interface. Options: `"run"`, `"debug"`, `"watch"`, `"coverage"`, `"current-test-coverage"`.                                             |
