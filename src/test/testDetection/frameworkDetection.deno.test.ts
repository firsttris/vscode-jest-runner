...
describe('isDenoTestFile', () => {
    ...
    it('should detect import from jsr:@std/expect', () => {
        ...
        mockedFs.existsSync.mockReturnValue(true);
        mockedFs.readFileSync.mockReturnValue('import { expect } from "jsr:@std/expect";');
    ...
    it('should detect import from deno.land', () => {
        ...
        mockedFs.existsSync.mockReturnValue(true);
        mockedFs.readFileSync.mockReturnValue('import { assert } from "https://deno.land/std/testing/asserts.ts";');
