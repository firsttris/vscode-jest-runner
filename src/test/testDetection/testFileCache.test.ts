...
describe('TestFileCache', () => {
  ...
  describe('isTestFile', () => {
    it('should return true for a valid test file', () => {
      ...
      expect(
        mockedTestFileDetection.matchesTestFilePattern,
    ...
    it('should return false when there is a conflicting test framework', () => {
      ...
      expect(result).toBe(false);
      expect(
        mockedTestFileDetection.hasConflictingTestFramework,
      ).toHaveBeenCalledWith(filePath, 'jest');
    });
  ...
  describe('edge cases', () => {
    ...
    it('should recompute after invalidation even with same mocked values', () => {
      ...
      mockedTestFileDetection.matchesTestFilePattern = jest.fn(
        (_filePath: string) => {
          callCount++;
          return true;
        },
