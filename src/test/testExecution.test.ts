...
import { logTestExecution } from '../execution/TestProcessRunner';
    ...
    describe('Partial run (isPartialRun)', () => {
      it('should use buildTestArgs for Jest partial run with single test', () => {
        ...
        mockJestConfig = {
          ...
          buildJestArgs: jest
            .fn()
            .mockReturnValue(['mocked', 'partial', 'args']),
        } as unknown as TestRunnerConfig;
        ...
        expect(mockJestConfig.buildJestArgs).toHaveBeenCalledWith(
          ...
          [
            ...
            'default',
            '--reporters',
            expect.stringContaining('jest-reporter.cjs'),
          ],
        );
      ...
      it('should use buildTestArgs for Vitest partial run', () => {
        ...
        mockJestConfig = {
          ...
          buildVitestArgs: jest
            .fn()
            .mockReturnValue(['vitest', 'partial', 'args']),
        } as unknown as TestRunnerConfig;
        ...
        expect(mockJestConfig.buildVitestArgs).toHaveBeenCalledWith(
          ...
          [
            '--reporter=json',
            '--reporter=default',
            expect.stringContaining('vitest-reporter.cjs'),
          ],
        );
      ...
      it('should include coverage flags for Vitest partial run', () => {
        ...
        mockJestConfig = {
          ...
          buildVitestArgs: jest
            .fn()
            .mockReturnValue(['vitest', 'coverage', 'args']),
        } as unknown as TestRunnerConfig;
  ...
  describe('collectTestsByFile', () => {
    it('should collect tests from request include', () => {
      const testItem1 = new TestItem(
        'test1',
        'test1',
        Uri.file('/path/test1.spec.ts') as any,
      );
      const testItem2 = new TestItem(
        'test2',
        'test2',
        Uri.file('/path/test2.spec.ts') as any,
      );
    ...
    it('should exclude tests from request exclude', () => {
      const testItem1 = new TestItem(
        'test1',
        'test1',
        Uri.file('/path/test.spec.ts') as any,
      );
      const testItem2 = new TestItem(
        'test2',
        'test2',
    ...
    it('should collect children from parent test items', () => {
      const parentItem = new TestItem(
        'parent',
        'parent',
        Uri.file('/path/test.spec.ts') as any,
      );
      const childItem1 = new TestItem(
        'child1',
        'child1',
        Uri.file('/path/test.spec.ts') as any,
      );
      const childItem2 = new TestItem(
        'child2',
        'child2',
        Uri.file('/path/test.spec.ts') as any,
      );
  ...
  describe('canUseFastMode', () => {
    ...
    it('should return false when multiple tests in single file', () => {
      const testsByFile = new Map([
        [
          '/path/test.spec.ts',
          [new TestItem('test1', 'test1'), new TestItem('test2', 'test2')],
        ],
      ]);
